...
`,
	...
	rabbitmq.Spec.Override.StatefulSet.Spec.Template.Spec.Containers = []corev1.Container{
		{
	...
	rabbitmq.Spec.Override.StatefulSet.Spec.Template.Spec.InitContainers = []corev1.Container{
